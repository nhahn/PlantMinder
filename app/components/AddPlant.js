  ...
  render() {
    ...
    return (
      <div className="container fadeInX animated">
        ...
        <div className='row' id="fixed">
          ...
          <div className='col-sm-9'>
            ...
            {/*Switch Animation*/}
            <div id="trigger1" className="spacer" style={{minHeight: 100}}></div>
      ...
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        ...
        <text transform="matrix(1 0 0 1 191.1095 30.8321)" font-family="'ArialMT'" font-size="18.7046px">100%</text>
        <g id="netDropDown">
        <rect x="76.9" y="40.3" fill="#FCFCF8" stroke="#010101" stroke-width="3" stroke-miterlimit="10" width="181.1" height="193.8"/>
        <g>
            <text transform="matrix(1 0 0 1 92.3267 106.2575)" font-family="'ArialMT'" font-size="15px">GuestNetwork</text>
            <g>
        ...
        <g>
            <text transform="matrix(1 0 0 1 92.3265 134.2465)" font-family="'ArialMT'" font-size="15px">SecureNet</text>
            <g>
        ...
        <g className="wifiHighlight">
            <text transform="matrix(1 0 0 1 92.3265 162.2355)" fill="#010101" font-family="'ArialMT'" font-size="15px">PlantMinder</text>
            <g>
        ...
        <g>
            <text transform="matrix(1 0 0 1 92.3264 190.2244)" font-family="'ArialMT'" font-size="15px">FiosWiFi</text>
            <g>
        ...
        <g>
            <text transform="matrix(1 0 0 1 92.3265 80.2686)" font-family="'ArialMT'" font-size="15px">NetworkA</text>
            <g>
            ...
            <h4>Finally, enter the device identifier found on the back into the form below. This will associated the device with your account.</h4>
